...
const projects = [
  ...
  },  
  {
    ...
    overview:
      'AI tool that generates optimized Dockerfiles via LLMs, enforcing best practices and multi-stage builds.',
    tech: ['Python', 'Llama3', 'Docker', 'Google AI Studio'],
    link: 'https://github.com/siddheshengineer/LLM-based-projects',
  },
  {
    title: 'GitOps w/ K3d & FluxCD',
    overview:
      'Automates Flask app deployments using a GitOps workflow on K3d clusters integrated via Azure Arc and FluxCD.',
    tech: ['K3d', 'FluxCD', 'Azure Arc', 'Docker'],
  ...
  },
  {
    ...
    overview: 'A Node.js Todo application with PostgreSQL that utilizes automated ephemeral database branching via Neon and GitHub Actions, enabling isolated database testing in pull requests before merging schema changes into production.',
    tech: ['Node.js', 'PostgreSQL', 'Neon', 'GitHub Actions', 'CI/CD', 'Database Migrations'],
    link: 'https://github.com/siddheshengineer/Ephemeral-Database-CICD-project',
  },
  {
    title: 'Helm Vulnerability Scanner',
    overview:
      'Bash tool parsing Helm charts and scanning with Trivy to report container vulnerabilities before deploy.',
    tech: ['Bash', 'Helm', 'Trivy', 'Kubernetes'],
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {projects.map((p, i) => (
            ...
            >
              ...
              <p className="text-gray-300 mb-4 text-sm">{p.overview}</p>
